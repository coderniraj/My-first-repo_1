...
<head>
    ...
    <link rel="stylesheet" href="roominfo.css">
...
<body>
    <div class="item-container">
        ...
        <div class="main-item">
            <img src="home4.jpg" alt="" style="height: 70%;width: 70%;">
        </div>
        <h2 class="item-heading" style="text-align: center;">
            Villa
        </h2>
        ...
        <p class="item-price"><sup>$</sup>500.00/-</p>
